...
6. Reference: none
7. Learned profile: profile=taste_profile.json, genre=phonk, bpm=138, key=G minor, structures=1, entries=7, active_genre=trap, taste_strength=0.35, reference_mode=inspire