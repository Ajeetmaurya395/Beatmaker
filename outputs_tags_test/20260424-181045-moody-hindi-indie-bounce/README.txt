...
6. Reference: none
7. Learned profile: profile=taste_profile.json, genre=none, bpm=none, key=none, structures=0, entries=0, active_genre=bollywood, taste_strength=0.35, reference_mode=inspire