...
6. Reference: none
7. Learned profile: profile=taste_profile.json, genre=phonk, bpm=138, key=C# minor, structures=0, entries=1, active_genre=phonk, taste_strength=0.35, reference_mode=inspire